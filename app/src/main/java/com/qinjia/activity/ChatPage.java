...
import com.qinjia.adapter.ChatMessageAdapter;
import com.qinjia.util.CommonUtils;
import com.qinjia.util.FileUtil;
import com.qinjia.util.GotyeVoicePlayClickListener;
import com.qinjia.util.ProgressDialogUtil;
import com.qinjia.util.SendImageMessageTask;
import com.qinjia.util.ToastUtil;
import com.qinjia.view.RTPullListView;
 ...
 *         2014-12-24下午5:25:06
 */
public class ChatPage extends BaseActivity implements GotyeListener,
        OnClickListener {
    ...
    public static final String APPKEY = "fd7de1bb-9cd6-4b65-a67b-0c2ce3761cff";
    public static final String PACKAGENAME = "com.example.rongyundemo";
...
//		Log.e("user", user.name);
        Log.e("currentLoginUser", currentLoginUser.name);
    ...
    private void initView() {
        ...
        adapter = new ChatMessageAdapter(this, new ArrayList<GotyeMessage>(),friendName);
